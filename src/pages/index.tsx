      ...
      <div className={styles.main}>
        <div className={styles.profileName}>
          <div className={styles.userWrapper}>
            <h1>GIBRAN AKBAROMI LUHKITO</h1>
            <h6>BLOCKCHAIN DEVELOPER</h6>
            <div className={styles.contactItem}>
              <a href="mailto:gibran.akbaromi@gmail.com">
              ...
              <a href="https://wa.me/6285762125530" rel="whatsapp" target="_blank">
                <span className={styles.icContact}>
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="#" rel="github" target="_blank">
                <span className={styles.icContact}>
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className={styles.contentWrapper}>
          <div className={styles.contentSection}>
            <h2>SUMMARY</h2>
            <p>Odio pretium libero adipiscing mauris urna purus odio imperdiet. Aliquam felis lacinia arcu elementum pharetra at. Viverra massa lacus amet arcu consequat tortor tellus. Purus accumsan a velit curabitur scelerisque eu mattis nec. Dictum gravida dolor ullamcorper mauris id dis massa.</p>
